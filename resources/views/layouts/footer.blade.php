<div class="relative mt-16 bg-gray-400">
...
{{--        <path fill="bg-gray-400" d="M0 22L120 16.7C240 11 480 1.00001 720 0.700012C960 1.00001 1200 11 1320 16.7L1440 22V54H1320C1200 54 960 54 720 54C480 54 240 54 120 54H0V22Z"></path>--}}
{{--    </svg>--}}
    <div class="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
            ...
            <div class="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-4">
                ...
                <div>
                    <p class="font-semibold tracking-wide text-teal-accent-400">Portfolio</p>
                    <ul class="mt-2 space-y-2">
                        <li>
                ...
                <div>
                    <p class="font-semibold tracking-wide text-teal-accent-400">Mon parcours</p>
                    <ul class="mt-2 space-y-2">
                        <li>
